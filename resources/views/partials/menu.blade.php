<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('content_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/sliders*") ? "c-show" : "" }} {{ request()->is("admin/services*") ? "c-show" : "" }} {{ request()->is("admin/content-pages*") ? "c-show" : "" }} {{ request()->is("admin/page-sections*") ? "c-show" : "" }} {{ request()->is("admin/posts*") ? "c-show" : "" }} {{ request()->is("admin/content-categories*") ? "c-show" : "" }} {{ request()->is("admin/content-tags*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('page_section_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.page-sections.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/page-sections") || request()->is("admin/page-sections/*") ? "c-active" : "" }}">
