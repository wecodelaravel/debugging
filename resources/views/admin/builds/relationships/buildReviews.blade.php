...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-buildReviews">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($reviews as $key => $review)
                        <tr data-entry-id="{{ $review->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $review->published ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-buildReviews:not(.ajaxTable)').DataTable({ buttons: dtButtons })
