    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.page-sections.update", [$pageSection->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('css') ? 'is-invalid' : '' }}" name="css" id="css">{{ old('css', $pageSection->css) }}</textarea>
                @if($errors->has('css'))
                    <div class="invalid-feedback">
                        {{ $errors->first('css') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('js') ? 'is-invalid' : '' }}" name="js" id="js">{{ old('js', $pageSection->js) }}</textarea>
                @if($errors->has('js'))
                    <div class="invalid-feedback">
                        {{ $errors->first('js') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cdn_css') ? 'is-invalid' : '' }}" name="cdn_css" id="cdn_css">{{ old('cdn_css', $pageSection->cdn_css) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cdn_js') ? 'is-invalid' : '' }}" name="cdn_js" id="cdn_js">{{ old('cdn_js', $pageSection->cdn_js) }}</textarea>
