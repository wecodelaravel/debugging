    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.static-seos.update", [$staticSeo->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $staticSeo->meta_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_title') ? 'is-invalid' : '' }}" type="text" name="facebook_title" id="facebook_title" value="{{ old('facebook_title', $staticSeo->facebook_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter_title') ? 'is-invalid' : '' }}" type="text" name="twitter_title" id="twitter_title" value="{{ old('twitter_title', $staticSeo->twitter_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('facebook_description') ? 'is-invalid' : '' }}" name="facebook_description" id="facebook_description">{{ old('facebook_description', $staticSeo->facebook_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('twitter_description') ? 'is-invalid' : '' }}" name="twitter_description" id="twitter_description">{{ old('twitter_description', $staticSeo->twitter_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{{ old('meta_description', $staticSeo->meta_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_image_url') ? 'is-invalid' : '' }}" type="text" name="seo_image_url" id="seo_image_url" value="{{ old('seo_image_url', $staticSeo->seo_image_url) }}">
