                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.services.update", [$service->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $service->subtitle) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="intro" id="intro">{{ old('intro', $service->intro) }}</textarea>
                            @if($errors->has('intro'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('intro') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content" id="content">{{ old('content', $service->content) }}</textarea>
