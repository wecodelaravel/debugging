                    ...
                    <form method="POST" action="{{ route("frontend.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $testimonial->published || old('published', 0) === 1 ? 'checked' : '' }}>
                                <label for="published">{{ trans('cruds.testimonial.fields.published') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $testimonial->title) }}" required>
                            @if($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body" id="body">{!! old('body', $testimonial->body) !!}</textarea>
                            @if($errors->has('body'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('body') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="website" id="website" value="{{ old('website', $testimonial->website) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="signiture" id="signiture" value="{{ old('signiture', $testimonial->signiture) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="signiture_company" id="signiture_company" value="{{ old('signiture_company', $testimonial->signiture_company) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_link" id="button_link" value="{{ old('button_link', $testimonial->button_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_text" id="button_text" value="{{ old('button_text', $testimonial->button_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $testimonial->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.testimonials.storeCKEditorImages') }}', true);
