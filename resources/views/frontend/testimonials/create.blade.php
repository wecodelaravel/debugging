                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.testimonials.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rating" id="rating" value="{{ old('rating', '5') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="signiture" id="signiture" value="{{ old('signiture', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="signiture_company" id="signiture_company" value="{{ old('signiture_company', '') }}">
