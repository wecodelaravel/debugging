                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_title" id="sub_title" value="{{ old('sub_title', $slider->sub_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="main_title" id="main_title" value="{{ old('main_title', $slider->main_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_title_2" id="sub_title_2" value="{{ old('sub_title_2', $slider->sub_title_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slider_description" id="slider_description" value="{{ old('slider_description', $slider->slider_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="text_heading" id="text_heading" value="{{ old('text_heading', $slider->text_heading) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="heading_1" id="heading_1" value="{{ old('heading_1', $slider->heading_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="heading_2" id="heading_2" value="{{ old('heading_2', $slider->heading_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="heading_3" id="heading_3" value="{{ old('heading_3', $slider->heading_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="text" id="text" value="{{ old('text', $slider->text) }}">
                            @if($errors->has('text'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('text') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="main_button_text" id="main_button_text" value="{{ old('main_button_text', $slider->main_button_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="main_button_link" id="main_button_link" value="{{ old('main_button_link', $slider->main_button_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="main_button_tab_index" id="main_button_tab_index" value="{{ old('main_button_tab_index', $slider->main_button_tab_index) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="second_button_text" id="second_button_text" value="{{ old('second_button_text', $slider->second_button_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="second_button_link" id="second_button_link" value="{{ old('second_button_link', $slider->second_button_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="second_button_tab_index" id="second_button_tab_index" value="{{ old('second_button_tab_index', $slider->second_button_tab_index) }}" step="1">
