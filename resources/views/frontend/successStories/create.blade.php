    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.success-stories.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="story_about" id="story_about" value="{{ old('story_about', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="story" id="story">{!! old('story') !!}</textarea>
                            @if($errors->has('story'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('story') }}
                                </div>
