    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.success-stories.update", [$successStory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="title">{{ trans('cruds.successStory.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $successStory->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="story_about" id="story_about" value="{{ old('story_about', $successStory->story_about) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="story" id="story">{!! old('story', $successStory->story) !!}</textarea>
                            @if($errors->has('story'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('story') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="combined-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="services_useds[]" id="services_useds" multiple>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.success-stories.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('frontend.success-stories.storeMedia') }}',
    maxFilesize: 5, // MB
