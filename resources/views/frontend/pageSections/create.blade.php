    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.page-sections.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="custom_class" id="custom_class" value="{{ old('custom_class', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="section_title" id="section_title" value="{{ old('section_title', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="css" id="css">{{ old('css') }}</textarea>
                            @if($errors->has('css'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('css') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="js" id="js">{{ old('js') }}</textarea>
                            @if($errors->has('js'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('js') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="cdn_css" id="cdn_css">{{ old('cdn_css') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="cdn_js" id="cdn_js">{{ old('cdn_js') }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="use_editor" id="use_editor" value="1" {{ old('use_editor', 0) == 1 ? 'checked' : '' }}>
