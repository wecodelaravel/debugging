    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.static-seos.update", [$staticSeo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="page_name">{{ trans('cruds.staticSeo.fields.page_name') }}</label>
                            <input class="form-control" type="text" name="page_name" id="page_name" value="{{ old('page_name', $staticSeo->page_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_path" id="page_path" value="{{ old('page_path', $staticSeo->page_path) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $staticSeo->meta_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_title" id="facebook_title" value="{{ old('facebook_title', $staticSeo->facebook_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twitter_title" id="twitter_title" value="{{ old('twitter_title', $staticSeo->twitter_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="json_ld_tag" id="json_ld_tag">{{ old('json_ld_tag', $staticSeo->json_ld_tag) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="canonical" id="canonical" value="1" {{ $staticSeo->canonical || old('canonical', 0) === 1 ? 'checked' : '' }}>
                                <label for="canonical">{{ trans('cruds.staticSeo.fields.canonical') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_1" id="html_schema_1" value="{{ old('html_schema_1', $staticSeo->html_schema_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_2" id="html_schema_2" value="{{ old('html_schema_2', $staticSeo->html_schema_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_3" id="html_schema_3" value="{{ old('html_schema_3', $staticSeo->html_schema_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="body_schema" id="body_schema" value="{{ old('body_schema', $staticSeo->body_schema) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="facebook_description" id="facebook_description">{{ old('facebook_description', $staticSeo->facebook_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="twitter_description" id="twitter_description">{{ old('twitter_description', $staticSeo->twitter_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ old('meta_description', $staticSeo->meta_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="open_graph_type" id="open_graph_type">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="seo_image-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="menu_name" id="menu_name" value="{{ old('menu_name', $staticSeo->menu_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="seo_image_url" id="seo_image_url" value="{{ old('seo_image_url', $staticSeo->seo_image_url) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noindex" id="noindex" value="1" {{ $staticSeo->noindex || old('noindex', 0) === 1 ? 'checked' : '' }}>
                                <label for="noindex">{{ trans('cruds.staticSeo.fields.noindex') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="nofollow" id="nofollow" value="1" {{ $staticSeo->nofollow || old('nofollow', 0) === 1 ? 'checked' : '' }}>
                                <label for="nofollow">{{ trans('cruds.staticSeo.fields.nofollow') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noimageindex" id="noimageindex" value="1" {{ $staticSeo->noimageindex || old('noimageindex', 0) === 1 ? 'checked' : '' }}>
                                <label for="noimageindex">{{ trans('cruds.staticSeo.fields.noimageindex') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noarchive" id="noarchive" value="1" {{ $staticSeo->noarchive || old('noarchive', 0) === 1 ? 'checked' : '' }}>
                                <label for="noarchive">{{ trans('cruds.staticSeo.fields.noarchive') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="nosnippet" id="nosnippet" value="1" {{ $staticSeo->nosnippet || old('nosnippet', 0) === 1 ? 'checked' : '' }}>
                                <label for="nosnippet">{{ trans('cruds.staticSeo.fields.nosnippet') }}</label>
                            </div>
...
<script>
    ...
    url: '{{ route('frontend.static-seos.storeMedia') }}',
    maxFilesize: 5, // MB
