    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.static-seos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_path" id="page_path" value="{{ old('page_path', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twitter_title" id="twitter_title" value="{{ old('twitter_title', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="json_ld_tag" id="json_ld_tag">{{ old('json_ld_tag') }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="canonical" id="canonical" value="1" {{ old('canonical', 0) == 1 || old('canonical') === null ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_1" id="html_schema_1" value="{{ old('html_schema_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_2" id="html_schema_2" value="{{ old('html_schema_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="html_schema_3" id="html_schema_3" value="{{ old('html_schema_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="body_schema" id="body_schema" value="{{ old('body_schema', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="facebook_description" id="facebook_description">{{ old('facebook_description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="twitter_description" id="twitter_description">{{ old('twitter_description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="menu_name" id="menu_name" value="{{ old('menu_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="seo_image_url" id="seo_image_url" value="{{ old('seo_image_url', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noindex" id="noindex" value="1" {{ old('noindex', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="nofollow" id="nofollow" value="1" {{ old('nofollow', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noimageindex" id="noimageindex" value="1" {{ old('noimageindex', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="noarchive" id="noarchive" value="1" {{ old('noarchive', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="nosnippet" id="nosnippet" value="1" {{ old('nosnippet', 0) == 1 ? 'checked' : '' }}>
