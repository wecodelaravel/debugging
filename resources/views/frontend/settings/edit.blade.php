                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook_link" id="facebook_link" value="{{ old('facebook_link', $setting->facebook_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twitter_link" id="twitter_link" value="{{ old('twitter_link', $setting->twitter_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="youtube_link" id="youtube_link" value="{{ old('youtube_link', $setting->youtube_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_bio" id="short_bio">{{ old('short_bio', $setting->short_bio) }}</textarea>
