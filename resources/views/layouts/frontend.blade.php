                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('page_section_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.page-sections.index') }}">
                                    ...
                                    @can('success_story_access')
                                        <a class="dropdown-item" href="{{ route('frontend.success-stories.index') }}">
                                    ...
                                    @can('static_seo_access')
                                        <a class="dropdown-item" href="{{ route('frontend.static-seos.index') }}">
