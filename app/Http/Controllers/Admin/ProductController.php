...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['categories', 'tags', 'product_type'])->select(sprintf('%s.*', (new Product)->table));
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'product_types', 'tags'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('categories', 'tags', 'product_type');

        return view('admin.products.edit', compact('categories', 'product', 'product_types', 'tags'));
    }
